        ...
        if len(self.queue) > 0:
            ...
            for task_id, task in self.queue.items():
                ...
                if temp_da_type != "idle_tasker":
                    ...
                    # MODIFICATIONS IN TPINT EXEC PLAN FOR NON-MONGODB APPROACH
                    ...
                    # A -INF VALUE OF SCHEDULING KEY ASSIGNED TO
            ...
            if self.isExecuting() and not self.isInterrupting():
                ...
                if self.execField['da_type'] == "idle_tasker":
                    ...
                    # MODIFICATIONS IN TPINT EXEC PLAN FOR EXEC DA FOR NON-MONGODB APPROACH
